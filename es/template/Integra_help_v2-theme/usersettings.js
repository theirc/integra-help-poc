...
(function() {
  ...
  model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "#FCFF00");
	...
	model.publish(rh.consts('KEY_CUSTOM_BUTTONS_CONFIG'), [{"name":"Print","id":"0","key":"79","onclick":"rh.model.publish(rh.consts('EVT_PRINT_TOPIC'));return false;","title":"Print","image":"print_desktop.png"},{"name":"RemoveHighlight","id":"1","key":"80","onclick":"rh.model.publish(rh.consts('EVT_REMOVE_HIGHLIGHT'));return false;","image":"removesearch_mark.svg","selected_image":"removesearch_mark.svg"}])
