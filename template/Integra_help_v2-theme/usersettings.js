...
(function() {
  ...
  model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "#FCFF00");
	...
	model.publish(rh.consts('KEY_CUSTOM_BUTTONS_CONFIG'), [{"name":"Print","id":"2","key":"62","title":"Print","image":"print_desktop.png","onclick":"rh.model.publish(rh.consts('EVT_PRINT_TOPIC'));return false;"},{"name":"RemoveHighlight","id":"3","key":"63","title":"Remove Highlight","image":"removesearch_mark.svg","onclick":"rh.model.publish(rh.consts('EVT_REMOVE_HIGHLIGHT'));return false;"}])
