...
(function() {
  ...
  model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "#FCFF00");
	...
	model.publish(rh.consts('KEY_CUSTOM_BUTTONS_CONFIG'), [{"name":"English","id":"2","key":"252","href":"https://integra-help-staging.azurewebsites.net/#t=About_Integra.htm%23About_Integra","title":"ENGLISH","image":"EN.png","selected_image":"5s911lu0d1d0xncs9mypr4kr93to2ig1.png"},{"name":"French","id":"3","key":"354","title":"FRANÇAIS","href":"https://integra-help-staging.azurewebsites.net/fr/#t=About_Integra.htm%23About_Integra","image":"FR.png"},{"name":"Spanish","id":"4","key":"453","title":"ESPAÑOL","href":"https://integra-help-staging.azurewebsites.net/es/#t=About_Integra.htm%23About_Integra","image":"ES.png"},{"name":"Print","id":"0","key":"055","onclick":"rh.model.publish(rh.consts('EVT_PRINT_TOPIC'));return false;","title":"Print","image":"print_desktop.png"},{"name":"RemoveHighlight","id":"1","key":"156","onclick":"rh.model.publish(rh.consts('EVT_REMOVE_HIGHLIGHT'));return false;"}])
